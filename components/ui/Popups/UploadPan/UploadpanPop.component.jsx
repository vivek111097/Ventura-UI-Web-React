...
import styles from './UploadpanPop.module.css';
import Dragdropan from "./Dragdroppan.component";
...
const UploadpanPop = (props) =>{
    ...
    return(
        ...
        {image == null && opencam == false && (
            <div className="SignAdd">
                <div className="textCenter">
                    ...
                    <p className="subTitle">Click a photo of your PAN card or upload from files.</p>
                </div>
        ...
        {opencam &&(
            <Webcamupload func={pull_data} />
        )}
        {image && doctype != 'pdf' &&(
            <div className="SignAdd">
                <div className="textCenter">
                    <h2 className="title">PAN card selected</h2>
                    <p className="subTitle">Crop the photo to capture relevant details and remove unwanted area.</p>
                </div>
