...
const AddNominee = (props) => {
  ...
  useEffect(() => {
    ...
    const allreadyExistedNomineeData = async () => {
      ...
      switch (added_nomineeCount) {
        case 0:
          Set_Nominee_1_Share(100)
        case 1:
          Set_Nominee_1_Share(50)
          Set_Nominee_2_Share(50);
  ...
  const onSubmit = async (data) => {
      ...
      Guard_data = {
        nominee_guardian_details: {
          ...
          guardian_identification_type:
            selected_Document == "A" ? "aadhar" : "pan",
    ...
    const resp = await AxiosInstance.post(
      ...
      { phone: props.phone, nominee_data: [...addedNominee, responceObj] },
      {
        headers: {
